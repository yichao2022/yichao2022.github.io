...
[https://yichao2022.github.io](https://yichao2022.github.io) | [yichao.jin@utdallas.edu](mailto:yichao.jin@utdallas.edu) | +1 (682) 266-4185

**Specialization:** Public Health Economics | Behavioral Policy Analysis | Discrete Choice Experiments (DCE)

---

## Education

**Ph.D., Public Policy and Political Economy (Public Health Track)**, University of Texas at Dallas, Expected Spring 2026  
- **Distinction:** Recipient of the *Dean of Graduate Education Dissertation Research Award (2025)* — Competitive funding awarded for excellence in experimental design and policy-relevant research.
- **Dissertation:** *Dynamics of Intertemporal Choice in Vaccination Timing: A Discrete Choice Experiment Approach.*
- **Chair:** Dohyeong Kim | **Minor:** International Business and Public Policy
...
**Secondary:** Quantitative Policy Evaluation, Applied Microeconomics, AI in Social Science
...
- Led interdisciplinary studies combining geospatial analytics with behavioral experiment data.
...
- **Quantitative Methods for Policy Analysis (Graduate)**: Led Econometrics labs; specialized in R programming and causal inference interpretation.
- **Health Economics & Public Policy (Undergraduate)**: Developed case studies on market failures and vaccine externalities.
...
- **Certifications:** **Stanford Artificial Intelligence Graduate Certificate** (AI Foundations, Machine Learning); CITI Human Subjects Protection.
- **Software:** Stata, R, Python, MATLAB, LaTeX.
- **Methodologies:** Discrete Choice Experiments (DCE), Mixed Logit Models, Hyperbolic Discounting, Causal Inference, Structural Equation Modeling.
...
**Dohyeong Kim** (Chair)  
Professor, School of Economic, Political and Policy Sciences | University of Texas at Dallas  
Email: dohyeong.kim@utdallas.edu

**Soyoung Kwon**  
Associate Professor of Sociology | University of Texas at Dallas  
Email: soyoung.kwon@utdallas.edu

**Richard Scotch**  
Professor, School of Economic, Political and Policy Sciences | University of Texas at Dallas  
*Ph.D. Harvard University*; Research: Disability Policy, Health and Social Policy  
