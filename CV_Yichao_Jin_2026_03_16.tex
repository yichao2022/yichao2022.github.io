...
- \textit{Status}: \textbf{Dissertation Approved by Advisor} (March 2026). \\
...
\begin{enumerate}
    \item \textbf{``How Waiting Time Shapes Preventive Health Behavior: Evidence from Vaccination Decisions''} (with Dohyeong Kim, Zhen Tian) \\
    ...
    \begin{itemize}[noitemsep, topsep=0pt]
        ...
        \item \textbf{Recent Findings}: Identified significant interaction effects where \textbf{Urban-Rural divide} and \textbf{Education} levels moderate time sensitivity. Established \textbf{Institutional Trust} as a critical psychological buffer that mitigates wait-time friction.
...
\vspace{2em}
\begin{center}
    \textit{Last Updated: March 16, 2026}
\end{center}
